...
** Eglot
   ...
   (use-package eglot
     ...
     :config (add-to-list 'eglot-server-programs
                          '(elixir-ts-mode "~/emacs-grimoire/emacs-deps/language-server/elixir-ls-v0.16.0/language_server.sh")))

   ;; Add node bin to exec-path, I am using NVM
   ;;add-to-list 'exec-path "~/.nvm/versions/node/v18.18.0/bin")
   #+end_src
