...
** Elixir
   ...
   elixir language server for elixir-mode

#+NAME: elixir-mode-lsp
   #+BEGIN_SRC emacs-lisp
   (use-package lsp-mode
     ...
     (elixir-mode . lsp)
     :init
     (add-to-list 'exec-path "~/Downloads/elixir-ls")
     :config
  (setq
...
** LSP
   ...
   (with-eval-after-load 'lsp-mode
     ...
     ;; not needed, could  use ffip instead
     (setq lsp-enable-links nil)

     ;; auto restart lsp
     (setq lsp-restart 'auto-restart)

     ;; I only load needed client packages
     (setq lsp-client-packages '(lsp-elixir))
